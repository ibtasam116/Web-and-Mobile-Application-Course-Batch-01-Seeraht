...
// // Array 
let cities = ["Faisalabad", "Lahore", "karachi", "Islamabad", "Burewala", "Sheihupura", "Kashmir"]

for (let i = 0; i < cities.length; i++) {
    let num = i + 1;

    document.getElementById('originalTextBox').innerHTML += num + ') ' + cities[i] + "&nbsp;&nbsp;&nbsp;";
...
function printMyName() {
    ...
    if (!myName) {
        ...
        document.getElementById('outputResult').innerHTML = "Please Type Your Name.";
        return;
    }
...
function addYourCityInList() {
    ...
    document.getElementById('outputResult').innerHTML = '<span style="Color: green; font-size: 14px;"> "'+ City + '"</Span>' + ' has been successfully added into list.';
}
...
function generateTable() {
    ...
    for (let i = 1; i <= limit; i++) {
        document.getElementById('outputResult').innerHTML += tableNumber + " * " + i + " = " + tableNumber*i + "<br>";  
    }
