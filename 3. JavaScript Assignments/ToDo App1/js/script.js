...
// Save todo task item in the Browser local storage we use localstorage function using javascript

function saveTodoLacal(todoItem) {
    let todo;
...
function getTodosLocal(todoItem) {
    ...
    todo.forEach(function (todo) {
        ...
        const todoNewP = document.createElement("p");
        todoNewP.innerHTML = todo; // get value from localstorage
        todoNewDiv.appendChild(todoNewP);
